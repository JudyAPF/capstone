...
class BrandingNamingScreen extends StatefulWidget {
...
class _BrandingNamingScreenState extends State<BrandingNamingScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'This module covers essential aspects of branding and naming for your business. You will learn how to create a strong brand identity and choose the right name for your business. Complete each lesson to unlock the next, and finish with the Q&A section at the end.',
                style: TextStyle(
                  fontSize: 16,
                ),
