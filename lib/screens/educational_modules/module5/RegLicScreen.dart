...
class RegistrationLicensingScreen extends StatefulWidget {
...
class _RegistrationLicensingScreenState
    extends State<RegistrationLicensingScreen> {
  ...
  Future<void> _fetchProgress() async {
    try {
      ...
      DocumentReference progressDocRef =
          FirebaseFirestore.instance.collection('module5_progress').doc(uid);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'This module covers the essential steps for registering and licensing your business. '
                'Complete each lesson to ensure you meet all regulatory requirements before proceeding to the exam.',
                style: TextStyle(
                  fontSize: 16,
                ),
              ...
              _buildLessonButton(context,
                  'Lesson 1: Understanding Business Registration Requirements',
                  () {
                Navigator.push(
                  context,
              ...
              _buildLessonButton(
                  context, 'Lesson 2: Choosing the Right Business Structure',
                  () {
                Navigator.push(
                  context,
              ...
              _buildLessonButton(context,
                  'Lesson 4: Compliance with Local, State, and Federal Regulations',
                  () {
                Navigator.push(
                  context,
