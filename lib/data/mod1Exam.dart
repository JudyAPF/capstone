...
List<ExamQuestions> examQuestions = [
  ...
  ExamQuestions(
    examquestion: 'What does “Exam Complete” status indicate in the user progress document?',
    examoptions: ['User has completed the exam', 'User has started the exam', 'User has not started the exam', 'User has failed the exam'],
    examanswer: 'User has completed the exam',
  ),
  ExamQuestions(
  ...
  ExamQuestions(
    examquestion: 'Which analysis focuses on macro-environmental factors that affect an organization?',
    examoptions: ['PEST Analysis', 'Competitive Analysis', 'Market Research', 'SWOT Analysis'],
    examanswer: 'PEST Analysis',
  ),
  ExamQuestions(
  ...
  ExamQuestions(
    examquestion: 'Which of the following is not a benefit of Market Research?',
    examoptions: ['Customer Insights', 'Competitive Analysis', 'SWOT Analysis', 'Market Trends'],
    examanswer: 'SWOT Analysis',
  ),
  ExamQuestions(
    examquestion: 'Which analysis tool helps identify external factors like social trends?',
    examoptions: ['PEST Analysis', 'SWOT Analysis', 'Competitive Analysis', 'Market Research'],
    examanswer: 'PEST Analysis',
  ),
  ExamQuestions(
